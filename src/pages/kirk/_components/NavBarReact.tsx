const NavBarReact = ({ currentPath }: { currentPath: string }) => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 flex items-center justify-center p-8">
      <div className="w-full flex items-center justify-between md:px-12 px-6 py-2 rounded-3xl shadow-lg border border-white/10 bg-white/5 backdrop-blur-md">
        <a href="/kirk">
          <img
        ...
        <ul className="h-fit flex items-center justify-center gap-6 md:gap-12 py-4">
